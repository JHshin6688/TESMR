...
class FREEDOM(GeneralRecommender):
    ...
    def compute_normalized_laplacian(self, indices, adj_size):
        ...
        adj = torch.sparse_coo_tensor(indices, torch.ones_like(indices[0]), size = adj_size)
        ...
        return torch.sparse_coo_tensor(indices, values, size = adj_size)
    ...
    def get_norm_adj_mat(self):
        ...
        return torch.sparse_coo_tensor(i, data, size=(self.n_nodes, self.n_nodes))
    ...
    def pre_epoch_processing(self):
        ...
        self.masked_adj = torch.sparse_coo_tensor(all_indices, all_values, size = self.norm_adj.shape).to(self.device)
